...
<html lang="en">
    <head>
        ...
        <title>Bimbel Cahaya Admin</title> 

        <!-- Custom fonts for this template-->
        <link href="{{asset('css/backend/css/all.min.css')}}" rel="stylesheet" type="text/css">
            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                ...
                <div class="row">
                    ...
                    <div class="p-5">
                        ...
                        <h1 class="h4 text-gray-900 mb-4">Login Admin - Bimbel Cahaya</h1>
                        </div>
                        <br>
                        <form method="POST" action="{{ url('/belakang/login') }}" aria-label="{{ __('Login') }}" class="user">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                id="exampleInputEmail" name="username" value="{{ old('username') }}" aria-describedby="emailHelp" 
